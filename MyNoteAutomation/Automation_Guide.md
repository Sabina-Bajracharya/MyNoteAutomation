...
This repository contains automated tests for the My Note website using WebDriver in Java. The tests are designed to ensure that the website's key features and functionalities, including notes, login, and signup, work as expected.
